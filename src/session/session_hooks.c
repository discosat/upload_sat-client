...
PARAM_DEFINE_STATIC_VMEM(CLIENT_STATUS_LOG, upload_state, PARAM_TYPE_DATA, 188, 0, PM_CONF, upload_logs_init, NULL, client_storage, VMEM_UPLOAD_LOG_ADDR, "Upload Client status error log");
